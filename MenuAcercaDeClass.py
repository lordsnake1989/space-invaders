...
class MenuAcercaDe:
            ...
            for palabra in palabras:
                ...
                if texto_ancho_temp < espacio_horizontal_disponible:
                    ...
                    self.mostrar_texto(
                        ...
                        self.BLANCO,
                        self.ventana,
                        (self.ANCHO - font_contenido.size(texto_linea.strip())[0]) // 2,
                        y_offset
                    )
    ...
    def mostrar_menu(self):
        ...
        contenido = (
            "¡Explora la galaxia y aprende Programación Orientada a Objetos con Space Invaders!\n"
            "Cada nave y cada disparo son objetos interactivos.\n"
            "Proyecto final con menú, puntajes, récords y navegación completa.\n"
